...
public class AccountController {
    ...
    public String viewAccounts(Model model) {
        ...
        Integer loggedInUserId = getCurrentUserId(loggedInUsername); // Implement this method to map username to member_id
    ...
    private Integer getCurrentUserId(String username) {
        // Implement logic to fetch the member_id of the logged-in user from your database
