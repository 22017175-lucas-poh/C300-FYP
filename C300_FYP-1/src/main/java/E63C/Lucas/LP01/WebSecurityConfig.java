	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((authorizeHttpRequests) -> authorizeHttpRequests
				.requestMatchers("/Admin/Card", "/Admin/Card/Approve/*", "/Admin/Card/Reject/*", "/Admin/Card/Edit/*",
						"/Admin/Card/Delete/*", "/Account_type", "/Account_type/add", "/Account_type/edit/*",
						"/Account_type/delete/*")
				.hasAnyRole("BO", "FA")
				.requestMatchers("/Admin/consultations", "/Admin/consultations/edit/*", "/Admin/consultations/delete")
				.hasRole("FA").requestMatchers("/Member", "/Member/add", "/Member/edit/*", "/Member/delete/*")
				.hasRole("BO").requestMatchers("/").permitAll() // Home page is visible without logging in
				.requestMatchers("/register").permitAll().requestMatchers("/forget").permitAll()
